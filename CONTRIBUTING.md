...
1. Make sure you are familiar with: [Idris](https://www.idris-lang.org).
...
Before you report an issue, or wish to add cool functionality please try and check to see if there are existing [issues](https://github.com/jfdm/idris-commons/issues) and [pull requests](https://github.com/jfdm/idris-commons/pulls).
...
1. Fork the [main development repository](https://github.com/jfdm/idris-commons) on github e.g.
2. Clone your fork to your local machine:

```
$ git clone git@github.com/<your github user name>/idris-commons.git
```

3. Add `jfdm/idris-commons` as a remote upstream

```
$ git remote add upstream git@github.com:jfdm/idris-commons.git
```
...
1. Go to GitHub and submit a pull request to `idris-commons`
...
1. If there are tests then run the tests else add some tests.
